...
hexo.extend.filter.register('before_generate', function () {
  ...
  var internalSrcCDN = {
    ...
    main: "https://cdn1.tianli0.top/npm/hexo-theme-butterfly@".concat(version, "/source/js/main.min.js"),
    utils: "https://cdn1.tianli0.top/npm/hexo-theme-butterfly@".concat(version, "/source/js/utils.min.js"),
    translate: "https://cdn1.tianli0.top/npm/hexo-theme-butterfly@".concat(version, "/source/js/tw_cn.min.js"),
    local_search: "https://cdn1.tianli0.top/npm/hexo-theme-butterfly@".concat(version, "/source/js/search/local-search.min.js"),
    algolia_js: "https://cdn1.tianli0.top/npm/hexo-theme-butterfly@".concat(version, "/source/js/search/algolia.min.js")
  };
  var internalSrcLocal = {
    main_css: '/css/index.css',
    main: '/js/main.js',
    utils: '/js/utils.js',
  ...
  var defaultVal = function defaultVal(obj, choose) {
    if (obj === 'internal') {
      if (choose === 'local') return internalSrcLocal;else return internalSrcCDN;
    }
    ...
    if (obj === 'external') {
      if (choose === 'local') {
        ...
        try {
          var data = path.join(hexo.plugin_dir, 'hexo-butterfly-extjs/plugins.yml');
          result = hexo.render.renderSync({
            path: data,
            engine: 'yaml'
          });
  ...
  themeConfig.asset = Object.assign(defaultVal('internal', CDN.internal_provider), defaultVal('external', CDN.third_party_provider), deleteNullValue(CDN.option));
  /**
   * Capitalize the first letter of comment name
   */

  var use = comments.use;
  if (!use) return;
  ...
  var newArray = use.map(function (item) {
    return item.toLowerCase().replace(/\b[a-z]/g, function (s) {
